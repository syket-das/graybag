...
const ContactUs = () => {
  ...
  return (
    <div
      id="contact"
      className="max-w-5xl max-lg:max-w-3xl mx-auto b my-6 font-[sans-serif]"
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl md:text-4xl text-center font-bold">
          Let Us Know Your Query or Feedback
        </h2>
      </div>
      <div className="grid lg:grid-cols-3 items-start gap-4 p-2  rounded-lg mt-12">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="relative flex items-center">
                <Input
                  ...
                  className="px-2 py-3  w-full text-sm  border border-secondary focus:border-secondary-foreground outline-none"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
              ...
              <div className="relative flex items-center">
                <Input
                  ...
                  className="px-2 py-3  text-black w-full text-sm  border border-secondary focus:border-secondary-foreground outline-none"
                />
                <svg
                  fill="#bbb"
                  className="w-[18px] h-[18px] absolute right-2"
              ...
              <div className="relative flex items-center sm:col-span-2">
                <textarea
                  ...
                  className="px-2 pt-3  text-black w-full text-sm  border border-secondary focus:border-secondary-foreground outline-none"
                ></textarea>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#bbb"
              ...
              <div className="col-span-full">
                <p className="text-sm font-bold text-gray-300 mb-4">Subject</p>
                <RadioGroup defaultValue="comfortable" className="flex gap-4">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="Quiries" id="r1" />
                    <Label htmlFor="r1">Quiries</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="serviceRequest" id="r2" />
                    <Label htmlFor="r2">Service Request</Label>
                  </div>
                  <div className="flex items-center space-x-2">
